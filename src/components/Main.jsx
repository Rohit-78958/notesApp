                    ...
                    {!expanded ? (
                        ...
                        <>
                            ...
                            <div className="mt-4 flex justify-end">
                                <button 
                                    className={`${isPublic ? 'bg-green-500 hover:bg-green-600' : 'bg-yellow-500 hover:bg-blue-600'} text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${(!title.trim() || !content.trim()) ? 'opacity-50 cursor-not-allowed' : ''}`} 
